...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const question1 = document.getElementById('question13');
    const question2=document.getElementById('question23')
    const question3=document.getElementById('question33')
    const question4=document.getElementById('question43')
    ...
    const platforms=[new Platform(300, 410, createImages({imageScr: 'platform1.png'})), new Platform(690, 228, createImages({imageScr: 'platform1.png'})), new Platform(1300, 228,createImages({imageScr: 'platform1.png'})),new Platform(3300, 220, createImages({imageScr: 'platform1.png'}))
        ,new Platform(-1970, bottom, createImages({imageScr: 'floor.png'})), new Platform(-1, bottom, createImages({imageScr:"floor.png"})), new Platform(2380, bottom, createImages({imageScr:"platform1.png"})),
